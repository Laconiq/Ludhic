...
export default function GenreBadge({ genre, variant, showHash = true, href }: GenreBadgeProps) {
  ...
  const className = `px-2 py-0.5 sm:px-3 sm:py-1 bg-black/50 backdrop-blur-sm rounded-full text-cyan-300 border border-cyan-400/30 font-gaming text-xs sm:text-base${
